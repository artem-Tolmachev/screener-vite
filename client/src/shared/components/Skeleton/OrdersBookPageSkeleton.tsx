...
export default function OrdersBookPageSkeleton() {
  return (
    <div className="flex pr-10 py-14 pl-[12px] space-x-4 h-[85%] w-[100%] bg-blue-950">
        <div className="flex flex-col space-y-5 bg-gray-900 p-6 rounded-[5px] h-full w-full">
