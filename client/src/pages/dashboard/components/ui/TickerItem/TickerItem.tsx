...
const TickerItem = ({coinData, symbol, src, addCoin, flag, deliteCoin, closeModal}: Props) => {
    const marker = useAppSelector(state => state.coins.markers[symbol] || '');
    ...
    return (
        <div className={`${styles.item} ticker-item`} onClick={tickerHandler}>
           <div className='flex items-center'> 
                ...
                <IconCoin symbol={symbol} src={src}/></div>
