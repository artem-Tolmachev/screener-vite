...
function Table({ className, ...props }) {
    return (_jsx("div", { "data-slot": "table-container", className: "relative w-full h-[85%]", children: _jsx("table", { "data-slot": "table", className: cn("caption-bottom text-sm h-[200px]", className), ...props }) }));
}
function TableHeader({ className, ...props }) {
    return (_jsx("thead", { "data-slot": "table-header", className: cn("[&_tr]:border-b h-[10%]", className), ...props }));
}
function TableBody({ className, ...props }) {
    return (_jsx("tbody", { "data-slot": "table-body", className: cn("[&_tr:last-child]:border-0 overflow-y-auto w-full", className), ...props }));
}
...
function TableRow({ className, ...props }) {
    return (_jsx("tr", { "data-slot": "table-row", className: cn("hover:bg-muted/50 h-[38px] data-[state=selected]:bg-muted border-b transition-colors w-full", className), ...props }));
}
